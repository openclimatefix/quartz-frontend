...
const NotFoundPage: NextPage = () => {
  return (
    <>
      ...
      <div className="bg-surface-sunken flex flex-col min-h-screen pt-16">
        <Header isLoggedIn={false} />
        <main className="flex flex-col justify-center flex-grow w-full px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-content">
          <div className="py-16">
            <div className="text-center">
              ...
              <p className="mt-2 py-3 text-base text-content-muted">
