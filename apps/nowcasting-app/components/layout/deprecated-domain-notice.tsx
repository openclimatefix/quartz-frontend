...
const DeprecatedDomainNotice = () => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-surface-sunken bg-opacity-75">
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col items-center text-xs text-content-secondary px-8 py-12 bg-surface-sunken rounded-md">
          ...
          <div>
            <a className="text-lg uppercase btn" href="https://app.quartz.solar">
              Go to Quartz.solar
            </a>
          </div>
        </div>
