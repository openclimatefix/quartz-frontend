 ...
 *
 * It renders nothing at all for a country with no overlays configured — today that is every
 * country but GB, and a drawer holding nothing is worse than no drawer.
 */
