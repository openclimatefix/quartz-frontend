  ...
  return (
    <div
      ...
      style={{
        ...
        height: `${split.height}%`,
        // The scrub row lives in this card, so the narrowest the chart may be dragged is set by
        // that row rather than by the plot. See `geometry.ts` for where the number comes from.
        minWidth: MIN_CHART_WIDTH_WITH_SCRUB_PX
      }}
    >
      <section
        aria-label="Chart"
