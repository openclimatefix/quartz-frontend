  ...
  return (
    <div className="self-stretch flex-col justify-start items-start gap-4 flex">
        ...
        {toggle ? (
          <label className="flex-1 inline-flex justify-center items-center cursor-pointer pt-1 pb-1">
            <div
              ...
              className={`relative w-6 h-1 ${bgTheme} rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute ${formatToggle} after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:mt-[-3.5px] after:transition-slow `}
            ></div>
          </label>
        ) : null}
      </div>
      <div className="self-stretch flex-col justify-start items-center gap-1 flex">
        ...
        <div className="px-2 py-0.5 justify-center items-center inline-flex">
          <RightArrow />
        </div>
        <div
