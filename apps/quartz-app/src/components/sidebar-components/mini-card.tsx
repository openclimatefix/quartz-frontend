...
const MiniCard: React.FC<MiniCardProps> = ({icon, textTheme, bgTheme, actualGeneration, nextForecast}) =>
{
  return (
    <div className="self-stretch h-[84px] flex-col justify-start items-start gap-8 flex">
      ...
      <div className="self-stretch h-7 flex-col justify-start items-center gap-1 flex">
        ...
        <div className={`text-center ${textTheme} text-base  pb-4 font-bold font-sans leading-none mb-2"`}>{nextForecast}</div>
      </div>
      </div>
